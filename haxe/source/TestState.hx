...
class TestState extends FlxState
{
	...
	private var _rooms:Array<Rectangle>;	// a Vector that holds all our rooms
	private var _halls:Array<Rectangle>;	// a Vector that holds all our halls
	private var _leafs:Array<Leaf>;		// a Vector that holds all our leafs
	...
	override public function create():Void
	{
		...
		// add player sprite.
		add(_player = new FlxSprite(0, 0, "assets/guy.png"));
	...
	private function PlayMap():Void
	{
		...
		var newMap:FlxTilemap = new FlxTilemap().loadMap(FlxTilemap.bitmapToCSV(_mapData), "assets/tiles.png", 16, 16, FlxTilemap.OFF, 0, 0, 1);
		if (_map != null)
		{
